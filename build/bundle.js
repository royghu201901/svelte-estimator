var app = (function () {
    ...
    // (52:4) {#each orders as order (order.id)}
    function create_each_block(key_1, ctx) {
    	let tr;
    	let td0;
    	let t0_value = /*order*/ ctx[6].order + "";
    	let t0;
    	let t1;
    	let td1;
    	let t2_value = /*currencyFormat*/ ctx[2].format(/*order*/ ctx[6].price) + "";
    	let t2;
    	let t3;
    	let td2;
    	let i;
    	...
    	return {
    		...
    		c() {
    			...
    			attr(tr, "class", "order svelte-1krpfx8");
    			this.first = tr;
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(i, "click", stop_propagation(function () {
    						if (is_function(/*remove*/ ctx[4](/*order*/ ctx[6].id))) /*remove*/ ctx[4](/*order*/ ctx[6].id).apply(this, arguments);
    					})),
    					listen(tr, "click", function () {
    						if (is_function(/*edit*/ ctx[3](/*order*/ ctx[6].id, /*order*/ ctx[6].order, /*order*/ ctx[6].price))) /*edit*/ ctx[3](/*order*/ ctx[6].id, /*order*/ ctx[6].order, /*order*/ ctx[6].price).apply(this, arguments);
    					})
    				];
    		...
    		p(new_ctx, dirty) {
    			ctx = new_ctx;
    			if (dirty & /*orders*/ 1 && t0_value !== (t0_value = /*order*/ ctx[6].order + "")) set_data(t0, t0_value);
    			if (dirty & /*orders*/ 1 && t2_value !== (t2_value = /*currencyFormat*/ ctx[2].format(/*order*/ ctx[6].price) + "")) set_data(t2, t2_value);
    		},
    		d(detaching) {
    ...
    function create_fragment(ctx) {
    	...
    	let t7;
    	let td1;
    	let t8_value = /*currencyFormat*/ ctx[2].format(/*total*/ ctx[1]) + "";
    	let t8;
    	let each_value = /*orders*/ ctx[0];
    	const get_key = ctx => /*order*/ ctx[6].id;
      ...
      <th></th></tr>`;
    			...
    			t8 = text(t8_value);
    			attr(td1, "colspan", "2");
    			attr(table, "class", "primary svelte-1krpfx8");
    		},
    		m(target, anchor) {
    		...
    		p(ctx, [dirty]) {
    			if (dirty & /*edit, orders, remove, currencyFormat*/ 29) {
    			...
    			if (dirty & /*total*/ 2 && t8_value !== (t8_value = /*currencyFormat*/ ctx[2].format(/*total*/ ctx[1]) + "")) set_data(t8, t8_value);
    		},
    		i: noop,
    		o: noop,
    		d(detaching) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	return [orders, total, currencyFormat, edit, remove];
    }
    ...
    function create_fragment$2(ctx) {
    	...
    	function form_order_binding(value) {
    		/*form_order_binding*/ ctx[6](value);
    	}

    	function form_price_binding(value) {
    		/*form_price_binding*/ ctx[7](value);
    	}
